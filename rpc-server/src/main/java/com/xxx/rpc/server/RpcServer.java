 ...
 * @since 1.0.0
 */
//实现了ApplicationContextAware接口的bean，当spring容器初始化的时候，会自动调用setApplicationContext方法；
//实现了InitializingBean接口的bean，在所有的属性被初始化后，会调用在afterPropertiesSet方法（init之前）
public class RpcServer implements ApplicationContextAware, InitializingBean {
    ...
    //当spring容器初始化的时候，setApplicationContext方法会被调用
    @Override
    ...
    //当属性初始化之后，在bean的init之前，afterPropertiesSet方法会被调用
    @Override
